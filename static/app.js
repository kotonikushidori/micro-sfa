...
import { DEFAULT_LOCK_CONFIG } from '/constants.js'
...
const ROLE_CONFIG = {
  sales:     { defaultHash: '#my',        nav: ['#my', '#kanban'] },
  manager:   { defaultHash: '#kanban',    nav: ['#kanban', '#forecast', '#dashboard', '#coach'] },
  executive: { defaultHash: '#dashboard', nav: ['#dashboard'] },
